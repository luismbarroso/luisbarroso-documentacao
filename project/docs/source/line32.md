...
4. Depois deste Start realizado, cada uma das Estações vai apresentar a iluminação **Amarelo Fixo** e **Verde a Pisca**; O Semáforo, presente na Estação 40, apresentará a cor   **Amarelo Fixo**, indicando que a Ordem de Start na Linha ainda não foi dada, para isso basta dar a Ordem de Start no **Screen Line32** e desta forma o Semaforo irá apresentar a iluminação **Amarelo Fixo** e **Verde a Pisca**. Na HMI também é possivel observar a evolução do Estado da Linha, passado assim para a Etapa **Modo de Preparação**
