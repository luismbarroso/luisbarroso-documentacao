...
- Na fase inicial do processo, deve executar o **Init Manual** presente no **Screen Line32**, de forma a garantir que todos os **Input's**, **Output's** e **Memórias** estão *limpos*

- Com a inicilização feita, procedemos a seleção do Modo de Funcionamento: **Local, Scada, HMI**;

- Depois de selecionado o Modo de Funcionamento, procedemos à **Ordem Start** de todas as estações, no **Screen Stations** é possivel dar a **Ordem de Start de duas maneiras:**
...
- Depois do processo anterior realizado, procedemos a seleção do Modo de Marcha: Automatico ou Ciclo.
